...
describe('v3 updateImage and updateMetadata', () => {
  ...
  describe('updateImage', () => {
    ...
    test('chainId support - explicit Base chainId (now automatically detected)', async () => {
      ...
      const tx = await clankerWithExplicitChainId.getUpdateImageTransaction({
        token,
        newImage,
      });
    ...
    test('chainId support - explicit Abstract chainId (now automatically detected)', async () => {
      ...
      const tx = await clankerWithAbstractChainId.getUpdateImageTransaction({
        token,
        newImage,
      });
    ...
    test('chainId support - automatic detection from wallet client', async () => {
      ...
      const tx = await clankerAutoDetect.getUpdateImageTransaction({
        token,
        newImage,
      });
  ...
  describe('updateMetadata', () => {
    ...
    test('chainId support - explicit Base chainId (now automatically detected)', async () => {
      ...
      const tx = await clankerWithExplicitChainId.getUpdateMetadataTransaction({
        token,
        metadata,
      });
    ...
    test('chainId support - explicit Abstract chainId (now automatically detected)', async () => {
      ...
      const tx = await clankerWithAbstractChainId.getUpdateMetadataTransaction({
        token,
        metadata,
      });
    ...
    test('chainId support - automatic detection from wallet client', async () => {
      ...
      const tx = await clankerAutoDetect.getUpdateMetadataTransaction({
        token,
        metadata,
      });
