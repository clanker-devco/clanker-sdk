...
var import_client_sdk2 = require("@duneanalytics/client-sdk");
    ...
    return __async(this, null, function* () {
      ...
      try {
        ...
        const response = yield this.dune.runQuery({
          ...
          query_parameters: [
            new import_client_sdk2.QueryParameter(import_client_sdk2.ParameterType.TEXT, "blockchain", network),
            new import_client_sdk2.QueryParameter(import_client_sdk2.ParameterType.TEXT, "token_address", tokenAddress)
          ]
        });
