...
export const B3_FACTORY_ADDRESS: `0x${string}` = '0xF16De52f29D690d229273C583714bA622827a1F5';
export const B3_LOCKER_ADDRESS: `0x${string}` = '0x99fd7dd31879e38b701f644e041894626a32d3e4';
export const B3_VAULT_ADDRESS: `0x${string}` = '0x99f54b1f2266b683cb043bdb1996f7e8b7f034c9';
export const B3_WETH_ADDRESS: `0x${string}` = '0x4200000000000000000000000000000000000006';
