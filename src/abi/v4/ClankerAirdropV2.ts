export const ClankerAirdropv2_v4_abi = [
  {
    type: 'constructor',
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: 'adminClaimTime', type: 'uint256', internalType: 'uint256' },
      { name: 'adminClaimed', type: 'bool', internalType: 'bool' },
    ],
    stateMutability: 'view',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      { name: 'token', type: 'address', internalType: 'address' },
      { name: 'newMerkleRoot', type: 'bytes32', internalType: 'bytes32' },
    ],
    outputs: [],
    stateMutability: 'nonpayable',
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'userAmountStillLocked', type: 'uint256', indexed: false, internalType: 'uint256' },
    ],
    anonymous: false,
  },
  {
  ...
  { type: 'error', name: 'AirdropAlreadyExists', inputs: [] },
  { type: 'error', name: 'AirdropClaimsOccurred', inputs: [] },
  { type: 'error', name: 'AirdropLockupDurationTooShort', inputs: [] },
  { type: 'error', name: 'AirdropNotCreated', inputs: [] },
  { type: 'error', name: 'AirdropNotUnlocked', inputs: [] },
  { type: 'error', name: 'ClaimNotEnded', inputs: [] },
  { type: 'error', name: 'InvalidAirdropPercentage', inputs: [] },
