export const ClankerHook_DynamicFee_v4_1_abi = [
  {
    type: 'constructor',
    inputs: [
    ...
    outputs: [
      {
        ...
        components: [
          ...
          { name: 'maxLpFee', type: 'uint24', internalType: 'uint24' },
          { name: 'referenceTickFilterPeriod', type: 'uint256', internalType: 'uint256' },
          { name: 'resetPeriod', type: 'uint256', internalType: 'uint256' },
          { name: 'resetTickFilter', type: 'int24', internalType: 'int24' },
          { name: 'feeControlNumerator', type: 'uint256', internalType: 'uint256' },
          { name: 'decayFilterBps', type: 'uint24', internalType: 'uint24' },
        ],
      },
    ],
    stateMutability: 'view',
    ...
    outputs: [
      {
        ...
        components: [
          { name: 'referenceTick', type: 'int24', internalType: 'int24' },
          { name: 'resetTick', type: 'int24', internalType: 'int24' },
          { name: 'resetTickTimestamp', type: 'uint256', internalType: 'uint256' },
          { name: 'lastSwapTimestamp', type: 'uint256', internalType: 'uint256' },
          { name: 'appliedVR', type: 'uint24', internalType: 'uint24' },
          { name: 'prevVA', type: 'uint24', internalType: 'uint24' },
        ],
      },
    ],
    stateMutability: 'view',
  ...
  },
  {
    ...
    inputs: [
      { name: 'beforeTick', type: 'int24', indexed: false, internalType: 'int24' },
      { name: 'afterTick', type: 'int24', indexed: false, internalType: 'int24' },
    ],
    anonymous: false,
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'poolId', type: 'bytes32', indexed: false, internalType: 'PoolId' },
      { name: 'tickIfToken0IsClanker', type: 'int24', indexed: false, internalType: 'int24' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'extension', type: 'address', indexed: true, internalType: 'address' },
    ],
    anonymous: false,
  },
  {
  ...
  },
  {
    ...
    inputs: [
      { name: 'poolId', type: 'bytes32', indexed: false, internalType: 'PoolId' },
      { name: 'baseFee', type: 'uint24', indexed: false, internalType: 'uint24' },
      { name: 'maxLpFee', type: 'uint24', indexed: false, internalType: 'uint24' },
      {
      ...
      { name: 'resetPeriod', type: 'uint256', indexed: false, internalType: 'uint256' },
      { name: 'resetTickFilter', type: 'int24', indexed: false, internalType: 'int24' },
      { name: 'feeControlNumerator', type: 'uint256', indexed: false, internalType: 'uint256' },
      { name: 'decayFilterBps', type: 'uint24', indexed: false, internalType: 'uint24' },
    ],
    anonymous: false,
  },
  { type: 'error', name: 'BaseFeeGreaterThanMaxLpFee', inputs: [] },
  { type: 'error', name: 'BaseFeeTooLow', inputs: [] },
  { type: 'error', name: 'ETHPoolNotAllowed', inputs: [] },
  { type: 'error', name: 'HookNotImplemented', inputs: [] },
  { type: 'error', name: 'MaxLpFeeTooHigh', inputs: [] },
  { type: 'error', name: 'MevModuleEnabled', inputs: [] },
  { type: 'error', name: 'MevModuleNotOperational', inputs: [] },
  { type: 'error', name: 'NotPoolManager', inputs: [] },
  { type: 'error', name: 'OnlyFactory', inputs: [] },
  { type: 'error', name: 'OnlyFactoryPoolsCanHaveExtensions', inputs: [] },
