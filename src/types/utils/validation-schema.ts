...
export const poolConfigSchema = z.object({
  pairedToken: z.string().refine(isAddressRefinement, { message: 'Paired token must be a valid Ethereum address' }),
...
export const rewardsConfigSchema = z.object({
  ...
  creatorAdmin: z.string().refine(isAddressRefinement, { message: 'Creator admin must be a valid Ethereum address' }),
  creatorRewardRecipient: z.string().refine(isAddressRefinement, { message: 'Creator reward recipient must be a valid Ethereum address' }),
  interfaceAdmin: z.string().refine(isAddressRefinement, { message: 'Interface admin must be a valid Ethereum address' }),
  interfaceRewardRecipient: z.string().refine(isAddressRefinement, { message: 'Interface reward recipient must be a valid Ethereum address' })
});
